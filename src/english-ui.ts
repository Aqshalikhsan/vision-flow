...
const exactTranslations = new Map<string, string>([
  ...
  ["Atur area dataset", "Set dataset crop"],
  ["IMAGE CROP", "IMAGE CROP"],
  ["Full frame", "Full frame"],
  ["Crop aktif", "Crop active"],
  ["Reset crop", "Reset crop"],
  ["Upload full image", "Upload full image"],
  ["Crop & upload", "Crop & upload"],
  ["Mengunggah gambar", "Uploading images"],
  ["Menerapkan crop", "Applying crop"],
  ["contoh terkunci", "locked examples"],
  ["Auto-label dari contoh", "Auto-label from examples"],
  ["Mencariâ€¦", "Searchingâ€¦"],
  ["Tolak", "Reject"],
  [
    "Label dan simpan gambar sebelumnya sebagai contoh terlebih dahulu",
    "Label and save a previous image as an example first",
  ],
  ["Auto-label contoh gagal", "Example auto-label failed"],
  [
    "Draft diterima dan gambar dikunci sebagai contoh berikutnya",
    "Draft accepted and image locked as the next example",
  ],
  [
